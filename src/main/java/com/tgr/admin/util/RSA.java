...
public abstract class RSA {
	...
	public static byte[] decryptByPublicKey(byte[] data, String key) throws Exception {
		// 对密钥解密
		byte[] keyBytes = Base64.decode(key.toCharArray());
	 ...
	 * @throws Exception
	 */
	public static void initKey(String path) throws Exception {
		...
		FileWriter fw = new FileWriter(path + "/public_key.dat");
		fw.write(encode);
		fw.close();
		// 私钥
		RSAPrivateKey privateKey = (RSAPrivateKey) keyPair.getPrivate();
		encoded = privateKey.getEncoded();
		encode = Base64.encode(encoded);
		System.out.println(encode.length() +" , \r\n" + encode);
		fw = new FileWriter(path + "/private_key.dat");
		fw.write(encode);
		fw.close();
	}
